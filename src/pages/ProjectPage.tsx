...
export default function ProjectPage() {
  ...
  const [settings, setSettings] = useState<ProjectSettings>({
    ...
    font_sfx: "Komika Text",
    font_narration: "Agency Gothic",
    font_clean: "Nunito",
      ...
      .then((data) => {
        ...
        if (data.settings) {
          setSettings({
            ...
            font_sfx: data.settings.font_sfx || "Komika Text",
            font_narration: data.settings.font_narration || "Agency Gothic",
            font_clean: data.settings.font_clean || "Nunito",
            bubble_fit_manga: data.settings.bubble_fit_manga ?? false,
            font_color: data.settings.font_color || "auto",
            stroke_color: data.settings.stroke_color || "auto",
          });
        }
        if (data.metadata) {
